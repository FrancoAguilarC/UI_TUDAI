...
imagenBackground.src = "./images/4enLineaTvsMjuego.png";
...
//declaro imagen de dropbox para que cargue
var imagenDropbox = new Image();
imagenDropbox.onload = function(){return};
imagenDropbox.src = "./images/flecha_abajo.png";
...
class Juego{
    ...
    constructor(tamanio,fichaJugador1,fichaJugador2,imagenCasillero){
        ...
        this.tablero = new Tablero(ctx,tamanio,imagenCasillero,imagenDropbox);
